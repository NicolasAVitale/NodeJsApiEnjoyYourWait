...
function getPromocionesRouter(){
    ...
    router.post('/agregarProducto/:idPromocion', jwtMdw.ensureAuthenticated, async (req, res) => {
        try {
            await promocionesApi.agregarProductoApromocion(req.body.idProducto, req.params.idPromocion)
